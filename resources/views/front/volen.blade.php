...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
     ...
     <h3 class="text-light"><a href="https://ercelearning.com/"><span style="
    border-radius: 12px;
    color: black;
    padding: 4px;
