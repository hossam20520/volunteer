                        ...
                        <div class="form-group">
                            <select class="form-input" id="country"  value="{{ $country }}" name="country">
                                <option selected disabled>Select Country</option>
                                 <option {{ $country = "Afganistan" ? "selected":"" }} value="Afganistan">Afghanistan</option>
                                 ...
                                 <option {{ $country = "Curaco" ? "selected":"" }} value="Curaco">Curacao</option>
                                 ...
                                 <option {{ $country = "Korea Sout" ? "selected":"" }} value="Korea Sout">Korea South</option>
                                 ...
                                 <option {{ $country = "Phillipines" ? "selected":"" }} value="Phillipines">Philippines</option>
                                 ...
                                 <option {{ $country = "United Arab Erimates" ? "selected":"" }} value="United Arab Erimates">United Arab Emirates</option>
                                 <option {{ $country = "United States of America" ? "selected":"" }} value="United States of America">United States of America</option>
                                 <option {{ $country = "Uraguay" ? "selected":"" }} value="Uraguay">Uruguay</option>
